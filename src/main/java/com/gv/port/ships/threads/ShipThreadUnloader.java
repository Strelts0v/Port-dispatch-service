...
/**
 * specifies actions for ship that going to unload supplies to storage of port
 */
public class ShipThreadUnloader extends Ship implements Runnable {

    /**
     * constructor for initializing object of ship thread that will unload supplies to storage of port
    ...
    /**
     * actions for ship that going to unload supplies to storage of port
     */
    public void run() {
        Dock dock = null;
        try {
